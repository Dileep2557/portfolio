...
const Hero = () => {
  ...
  return <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-section-bg to-background">
      <div className="container mx-auto px-6 text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold text-foreground mb-6 leading-tight">
            Hi, I'm{' '}
            <span className="text-accent">Dileep</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button variant="outline" size="lg" onClick={() => scrollToSection('contact')} className="text-lg px-8 py-6">
              Get In Touch
            </Button>
          </div>
        </div>
